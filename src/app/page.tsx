                  ...
                  return (
                    <div key={parentLoc.id} className="col-span-1">
                      <div className={`relative bg-gradient-to-br ${gradients[gradientIndex]} bg-[rgb(var(--card))] rounded-2xl p-4 shadow-sm border border-[rgb(var(--border))] hover:shadow-lg transition-all duration-300 group`}>
                        ...
                        {/* Action buttons - absolute positioned, outside the main button */}
                        <div className="absolute top-3 right-3 flex gap-1">
                          <button
                            ...
                            className="w-6 h-6 rounded-full bg-red-500/60 hover:bg-red-500 flex items-center justify-center text-white hover:scale-110 transition-all z-10"
                            title={t('deleteSpace')}
                          >
                          ...
                          <button
                            ...
                            className="w-6 h-6 rounded-full bg-[rgb(var(--primary))]/60 hover:bg-[rgb(var(--primary))] flex items-center justify-center text-white hover:scale-110 transition-all z-10"
                            title={t('addSubSpace')}
                          >
