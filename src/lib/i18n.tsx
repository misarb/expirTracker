...
const translations: Record<Language, Record<TranslationKey, string>> = {
    en: {
        ...
        addLocation: 'Add Space',
        quickActions: 'Quick Actions',
        searchPlaceholder: 'Search products...',
        allCategories: 'All Categories',
        allLocations: 'All Spaces',
        ...
        importWarning: 'Warning: Importing data will overwrite all current products, categories, and spaces. Are you sure?',
    ...
    fr: {
        ...
        manageLocations: 'Gérer les espaces',
        // Support
        ...
        addLocation: 'Ajouter Espace',
        quickActions: 'Actions Rapides',
        searchPlaceholder: 'Rechercher un produit...',
        allCategories: 'Toutes Catégories',
        allLocations: 'Tous Espaces',
        ...
        importWarning: 'Attention : L\'importation de données écrasera tous les produits, catégories et espaces actuels. Êtes-vous sûr ?',
    ...
    ar: {
        ...
        manageLocations: 'إدارة المساحات',
        // Support
        ...
        addLocation: 'إضافة مساحة',
        quickActions: 'إجراءات سريعة',
        searchPlaceholder: 'بحث عن منتج...',
        allCategories: 'كل الفئات',
        allLocations: 'كل المساحات',
